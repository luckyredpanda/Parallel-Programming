...
{
	{
		...
		auto qs1 = std::make_shared<QuickSorter<int>>();
		auto qs_w1 = AlgorithmWrapper<std::vector<int>, std::vector<int>>::create(qs1);


		auto tp3 = TaskPool<std::vector<int>, std::vector<int>>::create(qs_w1, num_threads_1);
		auto tp4 = TaskPool<std::vector<int>, int>::create(min_w, num_threads_2);

		auto comp1 = Composition<std::vector<int>, std::vector<int>, int>::create(tp3, tp4);
